...
**Status:** phase 3 — installer + librarian/memory + orchestrator/researcher/planner routing. Engineering, QA, and audit agents are still stubs; their functional behavior arrives in phase 4. See `plans/00-master-plan.md` for the full architecture and `plans/0N-*.md` for each phase.
